...
class Character:
    def __init__(self, chain_code, first_name, surname, species, age, gender, profession, planet, city, allegiance):
...
def create_character(config):
    ...
    city_species_factors = config.get("factors", {}).get("city_species", {}).get(city, {})
    ...
    adjusted_profession = {}
    city_profession_factors = config.get("factors", {}).get("city_profession", {}).get(city, {})
    species_profession_factors = config.get("factors", {}).get("species_profession", {}).get(species.lower(), {})
    ...
    adjusted_allegiance = {}
    city_allegiance_factors = config.get("factors", {}).get("city_allegiance", {}).get(city, {})
    species_allegiance_factors = config.get("factors", {}).get("species_allegiance", {}).get(species.lower(), {})
    profession_allegiance_factors = config.get("factors", {}).get("profession_allegiance", {}).get(profession.lower(), {})
    ...
    species_gender_factors = config.get("factors", {}).get("species_gender", {}).get(species.lower(), {})
    ...
    return Character(chain_code, first_name, surname, species, age, gender, profession, planet, city, allegiance)