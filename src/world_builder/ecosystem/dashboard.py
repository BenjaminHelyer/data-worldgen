"""
Basic dashboard for visualizing ecosystem data generated by the world_builder module.
"""
...
@st.cache
def load_data(path: str = "ecosystem.parquet") -> pd.DataFrame:
